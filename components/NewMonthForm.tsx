...
const NewMonthForm = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const found = months.find((month) => month.name === submitName);
      if (found) {
        showErrorToast(`${submitName} already exists!`);
      } else if (isFirstMonth && !submitIsDefault) {
        showErrorToast('The first month shall be default!');
      } else {
